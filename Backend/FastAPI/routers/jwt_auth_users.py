...
users_db = {
    "Alejo":{
        ...
        "diseable":False,
        "password":"$2a$12$PrQKZuA.1E5MYuevShn5L..jnbvoH6Y6YnhQrrtQyGMBG8t7/OXLS"
    }, 
    "Beto":{
        "username":"Beto",
        "full_name":"Humberto Rodriguez",
        "email":"alejo@gmail.com",
        "diseable":False,
        "password":"$2a$12$W40TnqZPxVDnwk3BTBTj1.WRANrO20hVZuhnjImQzpqrYwQgygRTW"
    }
}
...
async def login(form:OAuth2PasswordRequestForm = Depends()):
    ...
    access_token = {"sub":user.username, "exp":datetime.utcnow() + timedelta(minutes=ACCES_TOKEN_DURATION)}
